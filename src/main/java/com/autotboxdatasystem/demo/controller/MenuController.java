...
public class MenuController {
    ...
    public @ResponseBody ResponseEntity<String> addMenu (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody ResponseEntity<String> hardDeleteMenuById (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody ResponseEntity<String> softDeleteMenuById (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody ResponseEntity<String> restoreMenuById (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody ResponseEntity<String> activateMenuById (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody ResponseEntity<String> deactivateMenuById (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody ResponseEntity<String> updateMenuById (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody MenuEntity searchMenuById (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody MenuEntity searchMenuByMenuName (@RequestBody MenuEntity menuEntity){
    ...
    public @ResponseBody Page<MenuEntity> searchActivedMenu (@RequestBody PageEntity pageEntity){
    ...
    public @ResponseBody Page<MenuEntity> searchAllMenu (@RequestBody PageEntity pageEntity){
        Integer pageIndex = pageEntity.getPageIndex();
        Integer pageSize = pageEntity.getPageSize();
